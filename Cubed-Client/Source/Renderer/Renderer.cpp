...
namespace Cubed {
	...
	void Renderer::Render()
	{
		...
		glm::mat4 cameraTransform = glm::translate(glm::mat4(1.0), glm::vec3(0.0f, 0.0f, 3.0f));
		...
		m_PushConstants.Transform = glm::translate(glm::mat4(1.0), m_CubePosition) 
			* glm::eulerAngleXYX(glm::radians(m_CubeRotation.x), glm::radians(m_CubeRotation.y), glm::radians(m_CubeRotation.z));
	...
	void Renderer::RenderCube(const glm::vec3& position)
	{
		...
		glm::mat4 cameraTransform = glm::translate(glm::mat4(1.0), m_CameraPosition)
			* glm::eulerAngleXYX(glm::radians(m_CameraRotation.x), glm::radians(m_CameraRotation.y), glm::radians(m_CameraRotation.z));

		m_PushConstants.ViewProjection = glm::perspectiveFov(glm::radians(45.0f), viewportWidth, viewportHeight, 0.1f, 1000.0f)
			* glm::inverse(cameraTransform);

		m_PushConstants.Transform = glm::translate(glm::mat4(1.0), translation)
			* glm::eulerAngleXYX(glm::radians(m_CubeRotation.x), glm::radians(m_CubeRotation.y), glm::radians(m_CubeRotation.z));
